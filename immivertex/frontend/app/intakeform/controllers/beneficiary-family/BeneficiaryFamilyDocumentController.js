(function() {
  ...
  angular
    ...
    .controller("BeneficiaryFamilyDocumentController", BeneficiaryFamilyDocumentController);

  /**
   * @ngdoc Injector
   * @name BeneficiaryFamilyDocumentController
   * @private
   * @module immiApp.intakeform
   * @description
   ...
   * @copyright
   */
  BeneficiaryFamilyDocumentController.$inject = ["$scope"];
   ...
   * @copyright
   */
  function BeneficiaryFamilyDocumentController($scope) {
    var vm = this;
