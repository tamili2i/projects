(function() {
    ...
    angular.module("immiApp.intakeform")
        .controller("BeneficiaryFamilyAddressController", BeneficiaryFamilyAddressController);
    /**
     * @ngdoc Injector
     * @name BeneficiaryFamilyAddressController
     * @private
     ...
     * @copyright
     */
    BeneficiaryFamilyAddressController.$inject = ["$scope", "PlacesFactory", "Addressess", "Utils", "AddressTypes", "BeneficiaryFamily"];
     ...
     * @copyright
     */
    function BeneficiaryFamilyAddressController($scope, PlacesFactory, Addressess, Utils, AddressTypes, BeneficiaryFamily) {
      var vm = this;
      ...
      vm.addMailing = function (addressForms) {
        ...
        var mailing = {};
        mailing = Utils.getAddressModel(AddressTypes, "Mailing", BeneficiaryFamily.party_id);
      ...
      vm.addUsAddress = function(addressForms) {
        ...
        var usAddr = {};
        usAddr = Utils.getAddressModel(AddressTypes, "Residence", BeneficiaryFamily.party_id);
      ...
      vm.addAbroad = function(addressForms) {
        ...
        var abroadAddr = {};
        abroadAddr = Utils.getAddressModel(AddressTypes, "Foreign", BeneficiaryFamily.party_id);
      ...
      vm.addUsEmbassy = function (addressForms) {
        ...
        var usEmbassy = {};
        usEmbassy = Utils.getAddressModel(AddressTypes, "US Embassy", BeneficiaryFamily.party_id);
       ...
       * @param {object} evt
       * @description
       * Saves BeneficiaryFamily's Address information.
       *
       */
      vm.save = function(evt) {
        ...
        //TODO need to add BEneficiary family address API
