(function() {
    ...
    angular.module("immiApp.intakeform")
        .controller("BeneficiaryFamilyEmploymentController", BeneficiaryFamilyEmploymentController);
    /**
     * @ngdoc Injector
     * @name BeneficiaryFamilyEmploymentController
     * @private
     ...
     * @copyright
     */
    BeneficiaryFamilyEmploymentController.$inject = ["$scope", "Utils", "PlacesFactory","EmploymentType", "BeneficiaryFamily", "Employment"];
     ...
     * @copyright
     */
    function BeneficiaryFamilyEmploymentController($scope, Utils, PlacesFactory, EmploymentType, BeneficiaryFamily, Employment) {
        var vm = this;
        ...
        vm.addEmployment = function(employmentForms){
            ...
            employment = {
              "employment_information":{
                "address": {
                  "party_id": BeneficiaryFamily.party_id,
                  "location": {
                    "state_id": null,
                    "city_id": null,
                    "country_id": null
            ...
            employment.party_id = BeneficiaryFamily.party_id;
        ...
        */
        vm.removeEmployment = function(index, employmentId) {
          if(employmentId){
            //TODO API call for Employment delete func
          }
         ...
         * @param {object} evt
         * @description
         * Saves BeneficiaryFamily's Employment information.
         *
         */
        vm.save = function(evt) {
          //TODO API call for Employment Save
        };
