(function() {
    angular.module("immiApp.theme").controller("ThemeController", ["$scope", "$rootScope", "$theme", "$timeout", "progressLoader", "$location",
        function($scope, $rootScope, $theme, $timeout, progressLoader, $location) {
            "use strict";
